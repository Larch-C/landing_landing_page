  ...
  return (
    <section className="section stats-section">
      <div className="container">
        <h2 className="section-title text-center text-3xl font-bold text-[#f4f8ff]">{t('community.title')}</h2>
        <p className="text-center mb-10 text-[#cfe0ff]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-[1200px] mx-auto">
          <div className="bg-black/20 rounded-lg p-10 text-center transition hover:-translate-y-2 hover:shadow-xl">
            ...
            <div className="stats-number text-5xl font-bold text-[#e9eef9] mb-2 leading-none">{formatNumber(githubData.stars)}</div>
            <h3 className="text-xl mb-2 text-[#f4f8ff]">{t('community.stats.stars')}</h3>
          ...
          <div className="bg-black/20 rounded-lg p-10 text-center transition hover:-translate-y-2 hover:shadow-xl">
            ...
            <div className="stats-number text-5xl font-bold text-[#e9eef9] mb-2 leading-none">{formatNumber(githubData.forks)}</div>
            <h3 className="text-xl mb-2 text-[#f4f8ff]">{t('community.stats.forks')}</h3>
          ...
          <div className="bg-black/20 rounded-lg p-10 text-center transition hover:-translate-y-2 hover:shadow-xl">
            ...
            <div className="stats-number text-5xl font-bold text-[#e9eef9] mb-2 leading-none">{formatNumber(githubData.contributors)}</div>
            <h3 className="text-xl mb-2 text-[#f4f8ff]">{t('community.stats.contributors')}</h3>
          ...
          <div className="bg-black/20 rounded-lg p-10 text-center transition hover:-translate-y-2 hover:shadow-xl">
            ...
            <div className="stats-number text-5xl font-bold text-[#e9eef9] mb-2 leading-none">50+</div>
            <h3 className="text-xl mb-2 text-[#f4f8ff]">{t('community.stats.plugins')}</h3>
            <p className="text-[#cfe0ff]">{t('community.stats.pluginsDesc')}</p>
          </div>
        </div>
